...
export function SpiderCursor() {
    ...
    useEffect(() => {
        ...
        function spawn() {
            ...
            const r = window.innerWidth / rnd(120, 160)
            ...
            return {
                ...
                tick(t: number) {
                    ...
                    pts.forEach((pt) => {
                        ...
                        pt.t = 0
                        const increasing = len < window.innerWidth / 12 && i++ < 8
    ...
    return (
        <div className="fixed inset-0 w-full h-full pointer-events-none" style={{ zIndex: 9999 }}>
